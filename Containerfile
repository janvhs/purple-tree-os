...
RUN rpm-ostree install --assumeyes gnome-console

# Remove gnome-terminal
RUN rpm-ostree override remove --assumeyes gnome-terminal gnome-terminal-nautilus
RUN rm -rf /var/usrlocal/bin/gnome-terminal
